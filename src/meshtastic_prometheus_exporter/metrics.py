...
meshtastic_mesh_packets_snr_decibels = meter.create_gauge(
    name="meshtastic_mesh_packets_snr_decibels",
)

meshtastic_node_last_heard_timestamp_seconds = meter.create_gauge(
    name="meshtastic_node_last_heard_timestamp_seconds",
)

meshtastic_node_hop_start = meter.create_gauge(
    name="meshtastic_node_hop_start",
)
